          ...
          <div class="container">
            ...
            <div class="row">
              <div class="col-md-2">
                ...
                <div id="autores"> 
              <div class="col-md-2">
                <div class="card-fotos card-equal-height" style="height: 300px; margin-left: 25%">
                  <a href="livros.html">
                    <img src="img/autores/pessoa.jpg" width="100%" class="autores" style="margin-top: 50px;" alt="Fernando Pessoa" />
                  </a>
                  <div class="card-body2">
                    <h5 class="card-title tt">Fernando Pessoa</h5>
                  </div>
                  <h7 class="card-subtitle">10 publicações</h7>
                </div>
              </div>
              ...
              <div class="col-md-2">
                <a href="livros.html">
                <div class="card-fotos card-equal-height" style="height: 300px d-flex align-items-center justify-content-center; margin-left: 49% ">
                  <img src="img/autores/oda.png" width="100%" style="margin-top: 50px;"class="autores" alt="Livro1" />
                  <div class="card-body2">
                  </a>
               ...
               <div class="col-md-2">
                    <a href="livros.html">
                    <div class="card-fotos card-equal-height" style="height: 300px d-flex align-items-center justify-content-center; margin-left: 72% ">
                      <img src="img/autores/oda.png" width="100%" style="margin-top: 50px;"class="autores" alt="Livro1" />
                      <div class="card-body2">
                      </a>
                        <h5 class="card-tittle tt">Eichiro Oda</h5>
            ...
            <div class="col-md-2">
                    <a href="livros.html">
                    <div class="card-fotos card-equal-height" style="height: 300px d-flex align-items-center justify-content-center; margin-left: 98% ">
                      <img src="img/autores/oda.png" width="100%" style="margin-top: 50px;"class="autores" alt="Livro1" />
                      <div class="card-body2">
                      </a>
                        <h5 class="card-tittle tt">Eichiro Oda</h5>
                ...
                <div class="row" style="padding-top: 30px;">
                  ...
                  <div class="col-md-2">
                    ...
                    <div class="card-fotos card-equal-height" style="height: 300px d-flex align-items-center justify-content-center; margin-left: 40px;;">
                      <img src="img/autores/one.jpg" width="100%" style="margin-top: 50px;"class="autores" alt="Livro1" />
                      <div class="card-body2">
                      </a>
                  ...
                  <div class="col-md-2">
                    ...
                    <div class="card-fotos card-equal-height" style="height: 300px; margin-left: 80px">
                      <img src="img/autores/moyo.jpg"  width="100%" class="autores"  style="margin-top: 50px;" alt="Livro1" />
                      <div class="card-body2">
                      </a>
                  ...
                  <div class="col-md-2">
                    ...
                    <div class="card-fotos card-equal-height" style=" height: 300px; margin-left: 120px">
                      <img src="img/autores/ara.jpg" width="100%"   style="margin-top: 50px;"class="autores" alt="Livro1" />
                      <div class="card-body2">
                      </a>
                  ...
                  <div class="col-md-2">
                    ...
                    <div class="card-fotos card-equal-height" style=" height: 300px; align-items:center justify-content-center; margin-left: 160px">
                      <img src="img/autores/hanzo.jpg" width="100%"  style="margin-top: 50px;" class="autores" alt="Livro1" />
                      <div class="card-body2">
                      </a>
            ...
            <div class="modal-content">
                    ...
                    <div class="row">
                      ...
                      <form enctype="multipart/form-data" method="post" name="acao">
                        ...
                        <div class="inputBox">
                          ...
                          <br>
                          <select name="select" id="select_categoria">
                      ...
                      <div class="mx-auto" style="width: 50%">
                        ...
                        <div class="inputBox">
                          ...
                          <br>
                          <select name="select" id="select_periodo">
                          </select>
              ...
              <div class="modal-footer">
                ...
                if(isset($_POST["nome_autor"]) && isset($_POST["nacionalidade"]) &&
                   ...
                   var valor_categoria = categoria.options[categoria.selectedIndex].value;</script>";
                   $periodo =  "<script>
...
for(let item in data){
  ...
  <div class="col-md-12"> 
                    ...
                    <div class="card-fotos card-equal-height" style=" margin-left: 1%; padding-top: 10px "> 
                    <img src="img/autores/${data[item].tb03_foto_autor}" width="100%" style="margin-top: 50px;"class="autores" alt="Livro1" />
                      <div class="card-body2">
...
'${data[item].tb03_biografia}', ${data[item].tb03_foto_autor}, ${data[item].tb03_id_categoria}, 
${data[item].tb03_id_periodo})" class="icone">
...
var cod_alt =0;
  var codd = 0;
function editarAutor(nomeAutor, codigoAutor, nacionalidade, nascimento, falecimento, biografia, fotoAutor, idCategoria, idPeriodo){
  cod_alt = codigoAutor;
  codd = codigoAutor;
