...
tb01_sinopse, tb01_id_autor, tb03_nome_autor, tb04_nome_categoria,tb05_nome_periodo,
tb01_id_categoria, DATE_FORMAT(tb01_data, '%d/%m/%Y') AS tb01_data_formatada,
tb01_data, tb01_ftcapa, tb01_pdf, 
tb01_id_periodo, tb01_classificacao_indicativa,tb01_id_sala,
tb03_nome_autor, tb04_nome_categoria, tb05_nome_periodo, tb06_nome
FROM tb01_livro
