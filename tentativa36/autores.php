          ...
          <div class="modal-dialog">
            <div class="modal-content">
                ...
                <center>
                  <div class="card-modal">
                    <div class="row">
                      ...
                      <form enctype="multipart/form-data" method="post" aname="acao">
              ...
              <div class="modal-footer">
                ...
                <button type="submit" class="enter">Cadastrar</button>
                </form> 
    ...
    .then((data) => {
        ...
        var informacoes = `    <div class="col"> <br>
                <a href="#" id="link-card-livro" onclick="modalAutorLimpo()">
                  <div class="card card-equal-height" style="  margin-left: -100%;">
...
for(let item in data){
  ...
  informacoes += `
    ...
    <br>
      ...
      <div class="card-fotos card-equal-height" style=" padding-top: 10px "> 
